...
## Installation
  ...
  3. Install Rosetta (mainly for VCV)
  ...
  4. Run `requirements.yml` inside this directory to install required Ansible roles.
     * `ansible-galaxy install -r requirements.yml`
  6. Run `main.yml` inside this directory. Enter your macOS account password when prompted for the 'BECOME' password.
